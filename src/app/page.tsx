...
import { Phone, CheckCircle, Clock, Star, Wrench, TrendingUp, Users, AlertCircle, HelpCircle, MessageCircle, ShieldCheck } from 'lucide-react';
    ...
    <div className="premium-page min-h-screen">
        ...
        <div className="relative container mx-auto px-4 py-20 lg:py-32">
          <div className="max-w-4xl mx-auto">
            <motion.div
              variants={revealUp}
              style={{ y: heroCardY }}
              className="hero-main-card premium-glass-card rounded-[2rem] p-8 md:p-12"
            >
              ...
              <div className="text-center">
                <div className="flex justify-center mb-6">
                  <motion.div
                    ...
                    className="bg-yellow-100/80 p-6 rounded-full shadow-lg backdrop-blur-md"
                  >
                ...
                <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
                  <motion.a
                    ...
                    className="premium-button premium-button-primary text-white font-semibold px-8 py-4 rounded-2xl flex items-center justify-center gap-2"
                  >
                  ...
                  <motion.a
                    ...
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="premium-button premium-button-secondary text-yellow-700 font-semibold px-8 py-4 rounded-2xl flex items-center justify-center gap-2"
                  >
                ...
                <div className="flex flex-wrap justify-center gap-4 text-sm text-gray-600">
                  <span className="hero-chip flex items-center gap-1 px-4 py-2 rounded-full shadow-sm">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              <motion.div whileHover={{ scale: 1.08, rotate: -1.5 }} className="premium-soft-card text-center p-6 rounded-[1.5rem]">
      ...
      >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <motion.div whileHover={{ scale: 1.08, rotate: -1.5 }} className="premium-glass-card p-8 rounded-[1.75rem]">
      ...
      >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <motion.div whileHover={{ scale: 1.08, rotate: -1 }} className="premium-soft-card p-8 rounded-[1.9rem] border border-white/70">
            ...
            <motion.div whileHover={{ scale: 1.08, rotate: 1 }} className="premium-soft-card premium-soft-card-cool p-8 rounded-[1.9rem] border border-white/70">
              <div className="flex items-center gap-3 mb-6">
                <div className="bg-white/85 p-3 rounded-full shadow-lg backdrop-blur-md">
                  <img src="/logo-berkatproteksi.jpg" alt="Berkat Proteksi Logo" className="w-8 h-8 object-cover rounded-full shadow-sm" />
                </div>
          ...
          <div className="max-w-2xl mx-auto mt-12">
            <motion.div whileHover={{ scale: 1.03 }} className="premium-soft-card p-6 rounded-[1.65rem] border border-white/70">
      ...
      >
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-4xl mx-auto">
            <motion.div whileHover={{ scale: 1.02 }} className="premium-soft-card p-8 rounded-[1.75rem] mb-8 border border-white/70">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {riderCards.map((card) => (
                <motion.div
                  key={card.title}
                  whileHover={{ scale: 1.08, rotate: card.theme === "riot" || card.theme === "accident" ? -1.2 : 1.2 }}
      ...
      >
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <motion.div whileHover={{ scale: 1.08, rotate: -1.2 }} className="premium-pricing-card premium-pricing-card-side p-8 rounded-[1.9rem] border">
              ...
              <div className="mb-6">
                <div className="text-3xl font-bold text-white mb-4">Mulai dari Rp 500rb/thn</div>
              </div>
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="premium-button premium-button-muted w-full text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2"
              >
                <MessageCircle className="w-5 h-5 floating-icon" />
                Pilih Paket
              </a>
            </motion.div>
            <motion.div whileHover={{ scale: 1.08, y: -6 }} className="premium-pricing-card premium-pricing-card-featured p-8 rounded-[2rem] border relative md:scale-[1.05]">
              <div className="premium-pricing-glow" aria-hidden="true" />
              <div className="absolute -top-5 left-1/2 transform -translate-x-1/2 premium-badge text-white px-5 py-2 rounded-full text-sm font-semibold">
                Paling Populer
              </div>
              <div className="text-center mb-6">
              ...
              <div className="mb-6">
                <div className="text-3xl font-bold text-white mb-4">Mulai dari Rp 2.5jt/thn</div>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2">
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="premium-button premium-button-primary w-full text-white font-semibold py-3 rounded-xl flex items-center justify-center gap-2"
              >
                <MessageCircle className="w-5 h-5 floating-icon" />
                Pilih Paket
              </a>
            ...
            <motion.div whileHover={{ scale: 1.08, rotate: 1.2 }} className="premium-pricing-card premium-pricing-card-side p-8 rounded-[1.9rem] border">
              ...
              <div className="mb-6">
                <div className="text-3xl font-bold text-white mb-4">Mulai dari Rp 3.5jt/thn</div>
              </div>
              <ul className="space-y-3 mb-8">
                <li className="flex items-center gap-2">
                  <CheckCircle className="w-5 h-5 text-yellow-300 floating-icon" />
          ...
          <div className="max-w-4xl mx-auto">
            <div className="space-y-4">
              {[
                ...
                <motion.div key={index} whileHover={{ scale: 1.02, x: index % 2 === 0 ? -4 : 4 }} className="premium-soft-card rounded-[1.35rem]">
                  <button
                    onClick={() => toggleFaq(index)}
                    className="w-full px-6 py-4 text-left flex items-center justify-between hover:bg-white/35 transition-colors duration-200 rounded-[1.35rem]"
                  >
                    <span className="font-semibold text-gray-900">{faq.question}</span>
                    <HelpCircle className={`w-5 h-5 text-yellow-600 transition-transform duration-200 floating-icon ${expandedFaq === index ? 'rotate-180' : ''}`} />
                  </button>
                  {expandedFaq === index && (
      ...
      {/* Footer */}
      <footer className="premium-footer text-white py-14">
        <div className="container mx-auto px-4">
          <div className="grid md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400">
                <li className="flex items-center gap-2">
                  <Phone className="w-4 h-4 floating-icon" />
                  WhatsApp: +62 878-3881-7889
                </li>
                  Email: info@berkatproteksi.my.id
                <li className="flex items-center gap-2">
                  <MessageCircle className="w-4 h-4 floating-icon" />
